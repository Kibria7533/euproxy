...
<div style="min-height: 100vh; display: flex; background: linear-gradient(135deg, #7c3aed 0%, #6d28d9 100%);">
    ...
    <div style="flex: 1; display: none; padding: 2rem; color: white; justify-content: center; align-items: center;" class="d-none d-lg-flex">
        <div style="text-align: center;">
            ...
            <p style="opacity: 0.8;">Create your account and start managing proxy users today</p>
        </div>
    </div>

    <!-- Right Side - Signup Form -->
    <div style="flex: 1; display: flex; align-items: center; justify-content: center; padding: 2rem; overflow-y: auto;">
        <div style="width: 100%; max-width: 450px; background: white; border-radius: 12px; padding: 2.5rem; box-shadow: 0 10px 40px rgba(0, 0, 0, 0.1); margin: 2rem 0;">
            <div style="text-align: center; margin-bottom: 2rem;">
                <h2 style="font-weight: 700; color: #000; margin-bottom: 0.5rem; font-size: 1.75rem;">Create Account</h2>
                <p style="color: #9ca3af;">Join euproxy and manage your proxy services</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="needs-validation">
                ...
                <div style="margin-bottom: 1.5rem;">
                    <label for="name" style="font-size: 14px; font-weight: 500; color: #000; margin-bottom: 0.5rem; display: block;">Full Name</label>
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    @enderror
                    <small style="color: #9ca3af; display: block; margin-top: 0.5rem;">Password must be at least 8 characters long</small>
                </div>

                <!-- Confirm Password Field -->
                <div style="margin-bottom: 1.5rem;">
                    <label for="password-confirm" style="font-size: 14px; font-weight: 500; color: #000; margin-bottom: 0.5rem; display: block;">Confirm Password</label>
                    <div style="display: flex; border-radius: 8px; border: 1px solid #e5e7eb; overflow: hidden;">
                        <span style="background: #f3f4f6; padding: 10px 12px; display: flex; align-items: center; color: #6b7280;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        <input 
                            ...
                            style="border: none; padding: 10px 12px; font-size: 14px; flex: 1;"
                        >
                        <button class="btn btn-light border-0" type="button" id="togglePasswordConfirm" style="cursor: pointer; background: #f3f4f6; border: none; padding: 10px 12px; display: flex; align-items: center; color: #6b7280;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                                <circle cx="12" cy="12" r="3"></circle>
                            </svg>
                ...
                <div style="margin-bottom: 1.5rem;">
                    <div style="display: flex; align-items: flex-start;">
                        <input class="form-check-input" type="checkbox" id="agree" name="agree" required style="width: 18px; height: 18px; margin-right: 0.5rem; margin-top: 2px; flex-shrink: 0;">
                        <label style="color: #9ca3af; font-size: 13px; margin: 0;" for="agree">
                            I agree to the <a href="#" style="color: #7c3aed; text-decoration: none;">Terms & Conditions</a> and <a href="#" style="color: #7c3aed; text-decoration: none;">Privacy Policy</a>
                        </label>
                    </div>
                </div>
                ...
                <div style="text-align: center;">
                    <p style="color: #9ca3af; font-size: 14px;">
                        ...
                        <a href="{{ route('login') }}" style="color: #7c3aed; text-decoration: none; font-weight: 500;">
                            Sign in here
                        </a>
                    </p>
                </div>
